...
Single track for learning theory and software development side by side. This file ingests `curriculum.md` and `nasiko-curriculum.md` as a graph-ordered synthesis and includes the full source-preserved corpus so the unified file can stand alone.

Teaching brief: `unified-instructions.md`.
...
|---|---|---|
| `CUR` | `curriculum.md` | Broad math, ML, DSP, CV, NLP, ASR, GenAI, GCP PMLE, bibliography, textbook chapter maps, Python library theory |
| `NAS` | `nasiko-curriculum.md` | Go control-plane curriculum, DS/algo/discrete math, PostgreSQL internals, HLD/LLD, system design, Nasiko capstone |
| `MLO-I` | `mlo-instructions.md` | Beginner-first math/ML teaching contract, JEE-style ramp, Python/NumPy scratch protocol |
| `NAS-I` | `nasiko-instructions.md` | Knowledge-graph execution, Go syntax locks, system-design, database, architecture, and capstone constraints |
...
## 6. Math and ML Spine From `curriculum.md`
...
## 7. Go, CS, DB, Architecture, and Nasiko Spine From `nasiko-curriculum.md`
...
- Mechanical, fluid, aerospace texts from `curriculum.md`.
...
The chapter lists from `curriculum.md` are retained as the reading atlas below. They are not taught as separate courses; each is entered only through the owner node that needs it.
...
## 13. Production ML and ML-System Case-Study Track
...
|---|---|
| `curriculum.md` bibliography | §8 |
| `curriculum.md` chapter maps | §9 |
| `curriculum.md` M1-M46 teaching spine | §5-S1 through §5-S21, §6 |
...
The curated graph above is the teaching order. The bounded source blocks below preserve the original curriculum source files verbatim for lossless, self-contained use. Use the graph, dedupe ledger, and stage map above for execution; use these blocks as the complete retained source corpus.
...
Diff rule: every line from `curriculum.md` and `nasiko-curriculum.md` must be recoverable from the bounded source blocks below. If a future edit changes a source file, rerun the extraction diff before treating this unified file as lossless.

### 18.2 Verbatim Source Blocks

<!-- BEGIN SOURCE: curriculum.md -->
# Master Curriculum
...
<!-- END SOURCE: curriculum.md -->

<!-- BEGIN SOURCE: nasiko-curriculum.md -->
...
<!-- END SOURCE: nasiko-curriculum.md -->
