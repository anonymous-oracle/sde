...
| R10 ML system-design case studies (D21; build rule prefix ML, run as `r10_mlcases.py`) | **done** | 2026-09-25 | `refactor-tools/r10_mlcases.py` (rules ML-1…ML-9) with `authored/mlcases/main-course.md`; a guide row, §2 IDs and seven register rows (`authored/guide/`); `verify.py` plans D6 |
