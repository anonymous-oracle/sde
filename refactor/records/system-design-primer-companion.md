...
**J1111** · ML-8 · anchor-rewrite

````text
- `A1…A11, B1…B6, C1…C7, D1…D5` — Curriculum module IDs. `Part V` = Curriculum's GCP service map.
````

**J1115** · R7-2 · §0.1–§0.3 replaced by the part's own §0 (generic rules are in the course guide)
...
**J1116** · R7-2 · anchor-rewrite

````text
### 0.4 Notation
````

**J1117** · R7-2 · copied preferences, contract and Lab Safety moved out
...
**J1118** · R7-3 · overlap-register slice moved to rule 0.3
