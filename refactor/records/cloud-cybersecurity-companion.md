...
**J1117** · R7-2 · §0.1–§0.3 replaced by the part's own §0 (generic rules are in the course guide)
...
**J1118** · R7-2 · anchor-rewrite

````text
### 0.4 Notation
````

**J1119** · R7-2 · copied preferences, contract and Lab Safety moved out
...
**J1120** · R7-3 · overlap-register slice moved to rule 0.3
