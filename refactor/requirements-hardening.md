# Revamp requirements — hardened (as of the end of R2b, 2026-09-24; D5–D12 added the same day)
...
2. **D12 scope:** the Go companion takes only Nasiko's Go language and engineering nodes. Do you also want its control-plane reconstruction phases (P0–P10), its service specifications, the payments addendum, or its mathematics / ML tracks brought in? Each would need its own home under D7.
