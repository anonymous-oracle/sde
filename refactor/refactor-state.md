...
| D21 | "Also refer @gcp-curriculum.md file for a 309 case study material present, only copy and integrate material related to those case studies and nothing else. Ingest, analyse and understand it. Report back once finished." (2026-09-25) | The source's case-study atlas (Part 9c) and index (Appendix M) become main course D6 Production ML System Design. D6 has the method, ten families with worked cases, three builds (ranker, ETA, fraud on tokens), the academic pass D6.D1–D6.D4 and D6-P1…D6-P8. The index becomes Appendix M, deduplicated to 299 entries and mapped to the families. The RAG build stays with FDE-25/FDE-CAP1. The classical zoo and the PMLE product depth are left out because D1, D3 and the PMLE part own them. |
